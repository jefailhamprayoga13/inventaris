...
if (isset($_POST['submit'])) {
    ...
    if ($password == $cpassword) {
        ...
        if (!$result->num_rows > 0) {
            $sql = "INSERT INTO users (username, nama, email, password, id_level, kode_jurusan)
                    VALUES ('$username','$nama', '$email', '$password', $id_level, $kode_jurusan)";
            $result = mysqli_query($conn, $sql);
            if ($result) {
            ...
            <div class="col-md-6 col-12">
             ...
             <div class="input-group">
               ...
               <div class="col-md-6 col-12">
                ...
                <div class="mb-3">
                  <input  class="form-control"  aria-label="Name" aria-describedby="email-addon"
                   type="text" placeholder="Level" name="id_level" value="3" readonly="true" required>
                </div>
            </div>
        </div>
