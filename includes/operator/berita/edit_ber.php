...
<div class="card card-success">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="card-body">
                ...
                <input type='hidden' class="form-control" name="id_berita" value="<?php echo $data_cek['id_berita']; ?>"
             readonly/>

           <div class="form-group row">
                <label class="col-sm-2 col-form-label">Nama Penyerah</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="nip" name="nama_penyerah" placeholder="Nama Penyerah" value="<?php echo $data_cek['nama_penyerah']; ?>" required>
                </div>
            </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="nip" name="jabatan_penyerah" value="<?php echo $data_cek['jabatan_penyerah']; ?>" required>
                </div>
            </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="nip" name="nama_penerima" placeholder="Nama Penerima" value="<?php echo $data_cek['nama_penerima']; ?>" required>
                </div>
            </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="nip" name="jabatan_penerima" placeholder="Jabatan Penerima" value="<?php echo $data_cek['jabatan_penerima']; ?>" required>
                </div>
            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="Ubah" value="Ubah" class="btn btn-primary">Ya</button>
            ...
            <a href="?page=data-ber" title="Kembali" class="btn btn-secondary">Batal</a>
        </div>
    </form>
</div>
...
<?php
    ...
    $sql_ubah = "UPDATE berita SET
        ...
        nama_penyerah='".$_POST['nama_penyerah']."',
        jabatan_penyerah='".$_POST['jabatan_penyerah']."',
          nama_penerima='".$_POST['nama_penerima']."',
            jabatan_penerima='".$_POST['jabatan_penerima']."'
