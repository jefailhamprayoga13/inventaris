<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT * FROM ruang WHERE id_ruang='".$_GET['kode']."'";
...
<div class="card card-success">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="card-body">
          ...
          <input type='hidden' class="form-control" name="id_ruang" value="<?php echo $data_cek['id_ruang']; ?>"
             readonly/>

            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Nama Jurusan</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control"  name="nama_ruang" value="<?php echo $data_cek['nama_ruang']; ?>"
                    />
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="kode_ruang" value="<?php echo $data_cek['kode_ruang']; ?>"
                    />
                </div>
            </div>
    ...
    <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="keterangan_ruang" value="<?php echo $data_cek['keterangan_ruang']; ?>"
                    />
                </div>
            </div>
...
<?php
    ...
    $sql_ubah = "UPDATE ruang SET
        ...
        keterangan_ruang='".$_POST['keterangan_ruang']."'
