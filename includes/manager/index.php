    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link active " href="?page=data-log">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
         ...
         <li class="nav-item">
          <a class="nav-link  " href="?page=data-ber">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          switch ($hal) {
            ...
            include "../default.php";
              ...
              break;
               ...
               case 'data-log':
          include "../loguser/logm.php";
          break;    

        //Inv
        case 'data-inv':
          include "../manager/inven/data_inv.php";
          break;

        case 'tambah-inv':
          include "../manager/inven/tambah_inv.php";
          break;

               case 'del-inv':
          include "../manager/inven/del_inv.php";
          break;

            case 'edit-inv':
          include "../manager/inven/edit_inv.php";
          break;

            case 'det-inv':
          include "../manager/inven/det_inv.php";
          break;
        
        //berita
          case 'data-ber':
          include "../manager/berita/data_ber.php";
          break;
...
//perawatan
          case 'data-per':
          include "../manager/perawatan/data_per.php";
          break;

        case 'tambah-per':
          include "../manager/perawatan/tambah_per.php";
          break;

               case 'del-per':
          include "../manager/perawatan/del_per.php";
          break;

            case 'edit-per':
          include "../manager/perawatan/edit_per.php";
          break;

          //perbaikan
          case 'data-perb':
          include "../manager/perbaikan/data_perb.php";
          break;

        case 'tambah-perb':
          include "../manager/perbaikan/tambah_perb.php";
          break;

               case 'del-perb':
          include "../manager/perbaikan/del_perb.php";
          break;

            case 'edit-perb':
          include "../manager/perbaikan/edit_perb.php";
          break;


            case 'setuju-perb':
          include "../manager/perbaikan/setuju_perb.php";
          break;

            case 'selesai-perb':
          include "../manager/perbaikan/selesai_perb.php";
          break;
           ...
           case 'data-lap-invv':
          include "../manager/perawatan/exportt.php";
          break;
           case 'data-lap-invvv':
          include "../manager/laporan/laporan_inventaris.php";
          break;

            case 'data-lap-invvvv':
          include "../manager/laporan/export_laporan_inventaris_excel.php";
          break;
